...
public protocol UpdateEndpoint: Endpoint {
    ...
    */
    static func update(_ id: String, version: UInt, actions: [[String: Any]], expansion: [String]?, result: @escaping (Result<[String: AnyObject]>) -> Void)

}

public extension UpdateEndpoint {

    static func update(_ id: String, version: UInt, actions: [[String: Any]], expansion: [String]? = nil, result: @escaping (Result<[String: AnyObject]>) -> Void) {
